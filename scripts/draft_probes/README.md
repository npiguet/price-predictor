...
| `d3_exchange.py` | "What it learned is a policy, not a memorised trajectory" — state exchange between agents, and the per-pick policy-movement profile | `d3_*.json` / `.csv` |
