...
| `c12_on_curve.py` | the encoder's mana curve figure: vanilla statlines P 0–8 × T 1–8 swept over MV 1–10, best-read cost per statline among its printed costs | `c12_on_curve.csv`, `c12_best_mv.csv` |
