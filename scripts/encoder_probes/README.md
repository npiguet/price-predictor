...
| `c11_pip_ladder.py` | the pip-intensity ladder: real {2}{M} cards re-encoded at {3} / {2}{M} / {1}{M}{M} / {M}{M}{M} ({M} = one fixed color), both heads, per card class | `c11_pip_ladder.csv` |
