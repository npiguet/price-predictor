...
- [ ] T036 [US2] Three additive changes to `src/draft/application/generate_draft_data.py`, all behaviour-preserving for existing callers:
...
- [ ] T042 [US2] Implement `TrainDraftAgentOnlineUseCase.execute` in `src/draft/application/train_draft_agent_online.py`:
