...
- [X] T008 [P] [US1] Write test for `--aux-lambda` CLI argument in tests/unit/infrastructure/test_cli_train_transformer.py. Test: flag is parsed as float; default is 0.0; value is passed to train_transformer() call.
