...
- [x] The new-code surface is explicitly scoped: only the RL trainer (US1), the corpus provenance field, and the trainer's multi-corpus input (Assumptions; US1).
...
- **Validation outcome (2026-06-13)**: all items pass. No `[NEEDS CLARIFICATION]` markers; ambiguities were resolved into the **Assumptions** section.
